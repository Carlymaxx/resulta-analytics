...
const mockNotifications = [
  { id: 1, type: "alert", title: "At-Risk Student Detected", message: "Alex Johnson from Grade 9 has dropped below passing grade in Mathematics", time: "5 min ago", read: false, schoolId: "school-nairobi-high" },
  ...
  { id: 5, type: "success", title: "Prediction Model Updated", message: "Our AI model has been retrained with new data - accuracy improved to 96%", time: "Yesterday", read: true, schoolId: "school-nairobi-high" },
  { id: 6, type: "info", title: "System Maintenance", message: "Scheduled maintenance on Saturday 2am-4am EST", time: "Yesterday", read: true, schoolId: "school-nairobi-high" },
  { id: 7, type: "alert", title: "New Enrollment", message: "New student John Smith added to Grade 9-B", time: "2 days ago", read: true, schoolId: "school-nairobi-high" },
  { id: 8, type: "success", title: "Report Generated", message: "Q1 2025 Performance Report has been generated", time: "3 days ago", read: true, schoolId: "school-nairobi-high" },
];
...
export default function NotificationsPage() {
  ...
  const filtered = notifications.filter(n => !user?.schoolId || n.schoolId === user.schoolId)
    .filter(n => 
      filter === "all" 
        ? true 
        : filter === "unread" 
