    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Manage student boarding and room allocation</p>
        </div>
      ...
      {activeTab === "rooms" && (
        <div>
          <div className="flex gap-4 mb-4 text-sm">
            <span className="px-3 py-1 bg-slate-100 rounded-full text-slate-600 font-medium">Boys Block A</span>
              ...
              return (
                <div key={i} className="bg-white rounded-xl p-5 shadow-sm border border-slate-200">
                  ...
                  <div className="flex items-center justify-between text-sm mb-2">
                    <span className="text-slate-600">{room.occupied}/{room.capacity} beds</span>
              ...
              <tbody className="divide-y divide-slate-100">
                {students.map((s, i) => (
                  <tr key={i} className="hover:bg-slate-50">
                    ...
                    <td className="py-3 px-4 text-sm text-slate-600">Bed {s.bed}</td>
                    <td className="py-3 px-4 text-sm text-slate-600">{s.block}</td>
                    <td className="py-3 px-4 text-sm text-slate-600 font-mono">{s.parent}</td>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
            <div className="flex items-center justify-between p-6 border-b border-slate-200">
              <h2 className="text-lg font-bold text-slate-800">Allocate Bed</h2>
