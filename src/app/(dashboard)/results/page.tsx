  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Results Management</h1>
              ...
              <tr>
                <th className="text-left py-4 px-6 text-sm font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Student</th>
                 ...
                 {levelLearningAreas.map(area => (
                   <th key={area} className="text-center py-4 px-4 text-sm font-semibold text-slate-600 dark:text-slate-300 whitespace-nowrap">{area}</th>
                 ))}
                <th className="text-center py-4 px-4 text-sm font-semibold text-slate-600 dark:text-slate-300">Average</th>
        ...
        <div className="flex items-center justify-between py-4 px-6 border-t border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 border border-slate-200 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 disabled:opacity-50"
            >
            ...
            <form className="p-6 space-y-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {levelLearningAreas.map(learningArea => (
                        <div key={learningArea}>
                          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{learningArea}</label>
                          <input 
                            type="number" 
                            min="0" 
                            max="100"
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button 
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className="px-6 py-2.5 border border-slate-200 rounded-lg font-medium hover:bg-slate-50 dark:hover:bg-slate-700/50"
                >
                  Cancel
                </button>
                <button 
